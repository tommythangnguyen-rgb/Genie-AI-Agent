      ...
      <main className="max-w-4xl mx-auto px-6 pb-24 relative" style={{ zIndex: 1 }}>
        ...
        <section className="mb-10">
          ...
          <div className="rounded-2xl px-8 py-6 space-y-4" style={{ background: "rgba(255,255,255,0.05)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(255,255,255,0.14)", boxShadow: "0 4px 24px rgba(0,0,0,0.40), inset 0 1px 0 rgba(255,255,255,0.04)" }}>
            ...
            <p className="text-white/90 leading-relaxed">
              <strong className="text-white">Genie is not here to eliminate jobs.</strong> Financial aid professionals, advisors, and counselors bring irreplaceable judgment, relationships, and human accountability to the students they serve. No AI changes that. What Genie does is <strong className="text-white">fill the gaps</strong> — the after-hours question, the clarity before a meeting, the regulatory reference during a busy season — so that professionals can focus on what truly requires a human presence.
            </p>
            <p className="text-white/90 leading-relaxed">
            ...
            <p className="text-white/90 leading-relaxed">
              <strong className="text-white">Always verify.</strong> Genie provides general information based on federal regulation and best practices. It is not legal or financial advice. Always confirm important decisions with your institution's financial aid office and official FSA resources.
            </p>
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                body: "Genie is a general reference tool. It will always direct you to your institution and official FSA sources for decisions. Curiosity is encouraged. Dependency is not.",
              },
              {
